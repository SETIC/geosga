...
!function(){"use strict";function a(a,o,t,n,r,e,i){var s,c,d,l;a.marcador={},a.marcador.obra={},a.cadastrarMarcador=function(t){var n=a.myFile;a.$emit("LOAD"),console.log(n),o.cadastrarMarcador(t).then(function(t){a.marcador={},n&&o.uploadImagem(n,t.data.obra.id).then(function(o){a.myfile={},a.$emit("UNLOAD"),i(function(){$.notify({message:"Obra cadastrada com sucesso!"},{type:"success"}),$("#modal-cadastrar").modal("hide")},500)},function(o){$.notify({message:"Obra cadastrada com sucesso porém ocorreu um erro ao enviar a(s) imagens."},{type:"warning"}),a.$emit("UNLOAD")})},function(o){$.notify({message:"Ocorreu um erro ao cadastrar a obra, tente novamente. Se o erro persistir, contact o administrador do sistema."},{type:"warning"}),a.$emit("UNLOAD")})},a.listarTipos=function(){o.listarTipos().then(function(o){a.tipos=o.data},null)},a.setCategorias=function(o){a.categorias=angular.copy(o)},a.listarCategoriasPorTipo=function(t){o.listarCategoriasPorTipo(t).then(function(o){a.categorias=o.data},null)},a.listarStatus=function(){o.listarStatus().then(function(o){a.status=o.data},null)}(),a.modalCadastro=function(){$("#modal-cadastrar").modal("show")},a.initMap=function(){s=new google.maps.Map(document.getElementById("mapa"),{center:{lat:-5.7968718,lng:-35.4148505},zoom:12}),d=new google.maps.Geocoder,c=new google.maps.Marker({map:s}),google.maps.event.addListener(s,"click",function(o){a.marcador.latitude=o.latLng.lat(),a.marcador.longitude=o.latLng.lng();var n=new google.maps.LatLng(a.marcador.latitude,a.marcador.longitude);s.panTo(n),c.setPosition(n),d.geocode({location:n},function(o,n){if(n===google.maps.GeocoderStatus.OK){o[0]&&(a.marcador.obra.rua=o[0].formatted_address);var r="<div.content><h4>"+o[0].formatted_address+'</h4><button class="btn btn-primary" ng-click="modalCadastro()">Cadastrar obra</button></div>',e=t(r)(a);l=new google.maps.InfoWindow({content:e[0]}),l.open(s,c)}})})}(),a.listarTipos()}angular.module("app.gerenciador").controller("cadastro.ctrl",a),a.$inject=["$scope","api.service","$compile","api.autenticacao.service","$window","Constants","$timeout"]}();
