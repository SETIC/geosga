...
(function(E, X) {
	...
	function L(a, b) {
		if (ya && !ca && b && b.opacity !== A) b.filter = "alpha(opacity=" + b.opacity * 100 + ")";
		u(a.style,
			b)
	}
	...
	function La(a, b) {
		for (var c = "{", d = !1, e, f, g, h, i, k = [];
			...
			if (d) {
				...
				if (f.length) f = f.join(":"), g = /\.([0-9])/, h = N.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e !== null && (e = z.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = Qa(f, e)
			}
			k.push(e);
			a = a.slice(c + 1);
			c = (d = !d) ? "}" : "{"
	...
	function rb(a) {
		return W.pow(10, S(W.log(a) / W.LN10))
	}
	...
	var A, y = E.document,
		...
		ca = y && y.createElementNS && !!y.createElementNS(Fa,
			"svg").createSVGRect,
		Qb = Na && parseInt(za.split("Firefox/")[1], 10) < 4,
		ga = y && !ca && !ya && !!y.createElement("canvas").getContext,
		cb, db, Nb = {},
		zb = 0,
		...
		z;
	z = E.Highcharts ? X(16, !0) : {
		win: E
	};
	z.seriesTypes = I;
	var Ga = [],
		ja, sa, o, Ha, Ab, Ba, M, V, H, Wa, Oa;
	pb.prototype = {
		dSetter: function() {
			var a = this.paths[0],
				b = this.paths[1],
	...
	if (E.jQuery) E.jQuery.fn.highcharts = function() {
		...
		if (this[0]) return a[0] ? (new(z[xa(a[0]) ? a.shift() : "Chart"])(this[0], a[0], a[1]), this) : T[K(this[0], "data-highcharts-chart")]
	};
	...
	O.prototype = {
		...
		css: function(a) {
			...
			if (e) {
				e = this.textWidth = a &&
					a.width && d.nodeName.toLowerCase() === "text" && C(a.width) || this.textWidth;
				b && (a = u(b, c));
				this.styles = a;
		...
		getBBox: function(a, b) {
			...
			f = p(b, this.rotation);
			g = f * fa;
			e !== A && (r = ["", f || 0, i && i.fontSize, h.style.width].join(","), r = e === "" || Rb.test(e) ? "num:" + e.toString().length + r : e + r);
			r && !a && (c = l[r]);
			if (!c) {
				if (h.namespaceURI === Fa || d.forExport) {
					try {
						...
						}, Na && j.textShadow ? (k = j.textShadow, j.textShadow = "") : m && m("none"), c = h.getBBox ? u({}, h.getBBox()) : {
							width: h.offsetWidth,
	...
	O.prototype["stroke-widthSetter"] = O.prototype.strokeSetter = function(a, b, c) {
		this[b] = a;
		if (this.stroke && this["stroke-width"]) this.strokeWidth = this["stroke-width"], O.prototype.fillSetter.call(this, this.stroke,
	...
	Ca.prototype = {
		...
		init: function(a, b, c, d, e, f) {
			...
			this.alignedObjects =
				[];
			this.url = (Na || mb) && y.getElementsByTagName("base").length ? E.location.href.replace(/#.*?$/, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") : "";
			this.createElement("desc").add().element.appendChild(y.createTextNode("Created with Highcharts 4.2.2"));
		...
		buildText: function(a) {
			for (var b = a.element, c = this, d = c.forExport, e = p(a.textStr, "").toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, k = K(b, "x"), j = a.styles, m = a.textWidth, l = j && j.lineHeight, n = j && j.textShadow, r = j && j.textOverflow === "ellipsis", s = g.length, R = m && !a.added &&
					this.box, v = function(a) {
						return l ? C(l) : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : j && j.fontSize || c.style.fontSize || 12, a).h
					}, x = function(a) {
						return a.replace(/&lt;/g, "<").replace(/&gt;/g, ">")
					}; s--;) b.removeChild(g[s]);
			!f && !n && !r && e.indexOf(" ") === -1 ? b.appendChild(y.createTextNode(x(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, R && R.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g,
				"<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), o(e, function(e, f) {
				var g, l = 0,
				...
				o(g, function(e) {
					if (e !== "" || g.length === 1) {
						...
						if (e !== " ") {
							...
							if (m) {
								for (var n = e.replace(/([^\^])-/g, "$1- ").split(" "), R = g.length > 1 || f || n.length > 1 && j.whiteSpace !== "nowrap", o, w, q, t = [], u = v(s), A = 1, B = a.rotation, z = e, D = z.length;
									(R || r) && (n.length || t.length);) a.rotation = 0, o = a.getBBox(!0), q = o.width, !ca && c.forExport && (q = c.measureSpanWidth(s.firstChild.data, a.styles)), o = q > m, w === void 0 && (w = o), r && w ?
									(D /= 2, z === "" || !o && D < 0.5 ? n = [] : (o && (w = !0), z = e.substring(0, z.length + (o ? -1 : 1) * ua(D)), n = [z + (m > 3 ? "\u2026" : "")], s.removeChild(s.firstChild))) : !o || n.length === 1 ? (n = t, t = [], n.length && (A++, s = y.createElementNS(Fa, "tspan"), K(s, {
										dy: u,
										x: k
									}), p && K(s, "style", p), b.appendChild(s)), q > m && (m = q)) : (s.removeChild(s.firstChild), t.unshift(n.pop())), n.length && s.appendChild(y.createTextNode(n.join(" ").replace(/- /g, "-")));
		...
		button: function(a, b, c, d, e, f, g, h, i) {
			...
			M(k.element, ya ? "mouseout" : "mouseleave", function() {
				j !== 3 && (m = [e, f, g][j], l = [n, r, s][j], k.attr(m).css(l))
			});
		...
		rect: function(a, b, c, d, e, f) {
			...
			if (f !== A) a.strokeWidth = f, a = g.crisp(a);
			if (e) a.r = e;
		...
		symbol: function(a, b, c, d, e, f) {
			...
			if (i) h = this.path(i), u(h, {
			...
			else if (k.test(a)) m = function(a, b) {
				a.element && (a.attr({
					width: b[0],
					height: b[1]
				...
				onload: function() {
					...
					m(h, Nb[j] = [this.width, this.height]);
		...
		symbols: {
			...
			callout: function(a, b, c, d, e) {
				...
				h &&
					h > c && e > b + g && e < b + d - g ? i.splice(13, 3, "L", a + c, e - 6, a + c + 6, e, a + c, e + 6, a + c, b + d - f) : h && h < 0 && e > b + g && e < b + d - g ? i.splice(33, 3, "L", a, e + 6, a - 6, e, a, e - 6, a, b + f) : e && e > d && h > a + g && h < a + c - g ? i.splice(23, 3, "L", h + 6, b + d, h, b + d + 6, h - 6, b + d, a + f, b + d) : e && e < 0 && h > a + g && h < a + c - g && i.splice(3, 3, "L", h - 6, b, h, b - 6, h + 6, b, c - f, b);
				return i
			}
		},
		...
		fontMetrics: function(a, b) {
			...
			!a && b && E.getComputedStyle &&
				(b = b.element || b, a = (c = E.getComputedStyle(b, "")) && c.fontSize);
		...
		label: function(a, b, c, d, e, f, g, h, i) {
			...
			Bb = function() {
				var a, b;
				a = m.element.style;
				n = (v === void 0 || x === void 0 || j.styles.textAlign) && q(m.textStr) && m.getBBox();
				j.width =
					(v || n.width || 0) + 2 * s + p;
				j.height = (x || n.height || 0) + 2 * s;
				z = s + k.fontMetrics(a && a.fontSize, m).b;
				if (y) {
					if (!l) a = ba, b = (h ? -z : 0) + ba, j.box = l = d ? k.symbol(d, a, b, j.width, j.height, gb) : k.rect(a, b, j.width, j.height, 0, gb["stroke-width"]), l.isImg || l.attr("fill", "none"), l.add(j);
					l.isImg || l.attr(u({
						width: B(j.width),
						height: B(j.height)
					}, gb));
	...
	u(O.prototype, {
			...
			if (this.added) {
				...
				if (b.tagName === "SPAN") {
					var i = this.rotation,
						j = C(this.textWidth),
						m = k && k.whiteSpace,
						l = [i, g, b.innerHTML, this.textWidth, this.textAlign].join(",");
					if (l !== this.cTT) {
		...
		setSpanRotation: function(a, b, c) {
			var d = {},
				e = ya ? "-ms-transform" : mb ? "-webkit-transform" : Na ? "MozTransform" : Lb ? "-o-transform" : "";
			d[e] = d.transform = "rotate(" + a + "deg)";
			d[e + (Na ? "Origin" : "-origin")] = d.transformOrigin = b * 100 + "% " +
				c + "px";
			L(this.element, d)
		},
	...
	if (!ca && !ga) {
		...
		var Cb = {
			...
			color: function(a, b, c, d) {
				...
				if (i) {
					...
					w[0] < 1 && a.push([1, w[1]]);
					o(a, function(a, b) {
						g.test(a[1]) ? (f = ia(a[1]), j = f.get("rgb"),
							m = f.get("a")) : (j = a[1], m = 1);
						q.push(a[0] * 100 + "% " + j);
						b ? (s = m, p = j) : (r = m, v = j)
					});
					if (c === "fill")
						if (i === "gradient") c = l.x1 || l[0] || 0, a = l.y1 || l[1] || 0, n = l.x2 || l[2] || 0, l = l.y2 || l[3] || 0, x = 'angle="' + (90 - W.atan((l - a) / (n - c)) * 180 / ra) + '"', ba();
						else {
							var k = l.r,
								t = k * 2,
								u = k * 2,
								...
								y, k = function() {
									...
									x = 'src="' + N.global.VMLRadialGradientURL + '" size="' + t + "," + u + '" origin="0.5,0.5" position="' + A + "," +
										B + '" color2="' + v + '" ';
									ba()
								};
							d.added ? k() : d.onAdd = k;
			...
			symbols: {
				arc: function(a, b, c, d, e) {
					...
					if (g - f === 0) return ["x"];
					f = ["wa", a -
						h, b - h, a + h, b + h, a + h * d, b + h * i, a + h * k, b + h * j
					];
		...
		z.VMLRenderer = J = function() {
			this.init.apply(this, arguments)
		};
		J.prototype = D(Ca.prototype, Cb);
		cb = J
	}
	Ca.prototype.measureSpanWidth =
		function(a, b) {
	...
	var Ob;
	if (ga) z.CanVGRenderer = J = function() {
	...
	Va.prototype = {
		addLabel: function() {
			...
			b = a.labelFormatter.call({
				...
				value: a.isLog ? ea(na(e)) : e
			});
			q(d) ? d && d.attr({
				text: b
			}) : (this.labelLength = (this.label = d = q(b) && g.enabled ?
				c.renderer.text(b, 0, 0, g.useHTML).css(D(g.style)).add(a.labelGroup) : null) && d.getBBox().width, this.rotation = 0)
		},
		...
		handleOverflow: function(a) {
			var b = this.axis,
				...
				l, n = {};
			if (h) h < 0 && c - i *
				k < f ? l = B(c / U(h * fa) - f) : h > 0 && c + i * k > e && (l = B((d - c) / U(h * fa)));
			else if (d = c + (1 - i) * k, c - i * k < f ? j = a.x + j * (1 - i) - f : d > e && (j = e - a.x + j * i, m = -1), j = F(b.slotWidth, j), j < b.slotWidth && b.labelAlign === "center" && (a.x += m * (b.slotWidth - j - i * (b.slotWidth - F(k, j)))), k > j || b.autoRotation && g.styles.width) l = j;
			if (l) {
				n.width = l;
		...
		getLabelPosition: function(a, b, c, d, e, f, g, h) {
			var i = this.axis,
				...
				n = e.y;
			q(n) || (n = i.side === 2 ? l.y + 8 : n = U(c.rotation * fa) * (l.y - c.getBBox(!1, 0).height / 2));
			a = a + e.x + l.x - (f && d ? f * k * (j ? -1 : 1) : 0);
			b = b + n - (f && !d ? f * k * (j ? 1 : -1) : 0);
			m && (c = g / (h || 1) % m, i.opposite && (c = m - c - 1), b += c * (i.labelOffset /
				m));
			return {
				x: a,
				y: B(b)
		...
		render: function(a, b, c) {
			var d = this.axis,
				...
				ba = !0,
				t = d.tickmarkOffset,
				u = this.getPosition(g,
					k, t, b),
				z = u.x,
				u = u.y,
				B = g && z === d.pos + d.len || !g && u === d.pos ? -1 : 1,
				c = p(c, 1);
			this.isActive = !0;
			if (r) {
				...
				if (m === A) {
					...
					if (!h) m.zIndex = 1;
					if (b) m.opacity = 0;
					this.gridLine = m = r ? f.path(k).attr(m).add(d.gridGroup) : null
				}
			...
			if (l && v) w === "inside" && (v = -v), d.opposite && (v = -v), h = this.getMarkPath(z, u, v, l * B, g, f), n ? n.animate({
				d: h,
				opacity: c
			...
			if (i && !isNaN(z)) i.xy = u = this.getLabelPosition(z, u, i, g, j, t, a, q), this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !p(e.showLastLabel, 1) ? ba = !1 : g && !d.isRadial && !j.step && !j.rotation && !b && c !== 0 && this.handleOverflow(u), q && a % q && (ba = !1), ba && !isNaN(u.y) ? (u.opacity = c, i[this.isNew ? "attr" : "animate"](u), this.isNew = !1) : i.attr("y", -9999)
		},
		destroy: function() {
			Sa(this, this.axis)
		}
	...
	z.PlotLineOrBand.prototype = {
		render: function() {
			...
			if (l)
				...
				} else if (n && n.length && (a.svgElem = l = w.path(n).attr(x).add(), v))
	...
	ka.prototype = {
		...
		defaultLabelFormatter: function() {
			...
			if (h) g = La(h, this);
				...
				for (; f-- && g === A;) c = Math.pow(1E3, f + 1), a >= c && b * 10 % c === 0 && e[f] !==
					null && (g = z.numberFormat(b / c, -1) + e[f]);
			g === A && (g = P(b) >= 1E4 ? z.numberFormat(b, -1) : z.numberFormat(b, -1, A, ""));
			return g
		},
		getSeriesExtremes: function() {
			...
			o(a.series, function(c) {
				if (c.visible || !b.options.chart.ignoreHiddenSeries) {
					...
					a.isLog && e <= 0 && (e = null);
					if (a.isXAxis) {
						if (d = c.xData, d.length) a.dataMin = F(p(a.dataMin, d[0]),
							Ra(d)), a.dataMax = t(p(a.dataMax, d[0]), Ea(d))
					} else {
						c.getExtremes();
						f = c.dataMax;
						c = c.dataMin;
		...
		adjustForMinRange: function() {
			var a =
				...
				f, g, h, i, k, j;
			if (this.isXAxis && this.minRange === A && !this.isLog) q(a.min) || q(a.max) ? this.minRange = null : (o(this.series, function(a) {
				i = a.xData;
		...
		setTickInterval: function(a) {
			...
			v = p(b.userMin, d.min);
			x = p(b.userMax, d.max);
			h ? (b.linkedParent = c[b.coll][d.linkedTo], c = b.linkedParent.getExtremes(), b.min = p(c.min, c.dataMin), b.max = p(c.max, c.dataMax), d.type !== b.linkedParent.options.type && X(11, 1)) : (!r && q(n) && (b.dataMin >= n ? (s = n, k = 0) : b.dataMax <= n && (R = n, i = 0)), b.min = p(v, s, b.dataMin), b.max = p(x, R, b.dataMax));
			if (e) !a && F(b.min, p(b.dataMin, b.min)) <= 0 && X(10, 1), b.min = ea(Da(b.min), 15), b.max = ea(Da(b.max), 15);
			if (b.range &&
				q(b.max)) b.userMin = b.min = v = t(b.min, b.minFromRange()), b.userMax = x = b.max, b.range = null;
			b.beforePadding && b.beforePadding();
			b.adjustForMinRange();
			if (!l && !b.axisPointRange && !b.usePercentage && !h && q(b.min) && q(b.max) && (c = b.max - b.min)) !q(v) && k && (b.min -= c * k), !q(x) && i && (b.max += c * i);
			...
			b.tickInterval = b.min === b.max || b.min === void 0 ||
				b.max === void 0 ? 1 : h && !j && m === b.linkedParent.options.tickPixelInterval ? j = b.linkedParent.tickInterval : p(j, this.tickAmount ? (b.max - b.min) / t(this.tickAmount - 1, 1) : void 0, l ? 1 : (b.max - b.min) * m / t(b.len, m));
		...
		setTickPositions: function() {
			...
			this.tickmarkOffset = this.categories &&
				a.tickmarkPlacement === "between" && this.tickInterval === 1 ? 0.5 : 0;
			this.minorTickInterval = a.minorTickInterval === "auto" && this.tickInterval ? this.tickInterval / 5 : a.minorTickInterval;
			this.tickPositions = b = c && c.slice();
			if (!b && (b = this.isDatetimeAxis ? this.getTimeTicks(this.normalizeTimeTickInterval(this.tickInterval, a.units), this.min, this.max, a.startOfWeek, this.ordinalPositions, this.closestPointRange, !0) : this.isLog ? this.getLogTickPositions(this.tickInterval, this.min, this.max) : this.getLinearTickPositions(this.tickInterval,
					this.min, this.max), b.length > this.len && (b = [b[0], b.pop()]), this.tickPositions = b, d && (d = d.apply(this, [this.min, this.max])))) this.tickPositions = b = d;
		...
		setScale: function() {
			...
			if (b || a || this.isLinked || this.forceRedraw || this.userMin !== this.oldUserMin || this.userMax !== this.oldUserMax || this.alignToOthers()) {
				if (this.resetStacks && this.resetStacks(), this.forceRedraw = !1, this.getSeriesExtremes(), this.setTickInterval(), this.oldUserMin = this.userMin, this.oldUserMax = this.userMax, !this.isDirty) this.isDirty = b ||
					this.min !== this.oldMin || this.max !== this.oldMax
		...
		getExtremes: function() {
			var a = this.isLog;
			return {
				min: a ? ea(na(this.min)) : this.min,
				max: a ? ea(na(this.max)) : this.max,
		...
		unsquish: function() {
			...
			c ? (m = !b.staggerLines && !b.step && (q(h) ? [h] : f < p(b.autoRotationLimit, 80) && b.autoRotation)) && o(m, function(a) {
				var b;
				if (a === h || a && a >= -90 && a <= 90) k = l(P(i.h / $(fa * a))), b = k + P(a / 360), b < j && (j = b, g = a, e = k)
			}) : b.step || (e = l(i.h));
			this.autoRotation =
				m;
		...
		renderUnsquish: function() {
			...
			if (k.rotation && (m = {
					width: (l > a.chartHeight * 0.5 ? a.chartHeight * 0.33 : a.chartHeight) +
						"px"
		...
		getOffset: function() {
			...
			if (r && r.text && r.enabled !== !1) {
				...
				if (j) m = a.axisTitle.getBBox()[g ? "height" : "width"], l = r.offset, n = q(l) ? 0 : p(r.margin, g ? 5 : 10);
		...
		render: function() {
			...
			if (a.hasData() || f) {
				...
				if (g.length && (o(g, function(b, c) {
					...
					}), n && (a.min === 0 || a.single))) i[-1] ||
					(i[-1] = new Va(a, -1, null, !0)), i[-1].render(-1);
				l && o(g, function(c, d) {
					t = g[d + 1] !== A ? g[d + 1] + n : a.max - n;
					if (d % 2 === 0 && c < a.max && t <= a.max + (b.polar ? -n : n)) j[c] || (j[c] = new z.PlotLineOrBand(a)), w = c + n, j[c].options = {
						from: e ? na(w) : w,
						to: e ? na(t) : t,
						color: l
			...
			if (r) s = a.getLinePath(r), a.axisLine ? a.axisLine.animate({
				...
				"stroke-width": r,
				zIndex: 7
			}).add(a.axisGroup), a.axisLine[v ? "show" : "hide"](!0);
		...
		drawCrosshair: function(a, b) {
			var c, d = this.crosshair,
				e, f;
			if (!this.crosshair ||
				(q(b) || !p(d.snap, !0)) === !1) this.hideCrosshair();
	...
	ka.prototype.getTimeTicks = function(a, b,
		c, d) {
		var e = [],
			f = {},
			g = N.global.useUTC,
		...
		if (q(b)) {
			...
			if (k >= G.minute) i[Ib](k >= G.hour ? 0 : j * S(i[tb]() / j));
			if (k >= G.hour) i[Jb](k >= G.day ? 0 : j * S(i[ub]() / j));
			if (k >= G.day) i[wb](k >= G.month ? 1 : j * S(i[$a]() / j));
			k >= G.month && (i[xb](k >= G.year ? 0 : j * S(i[ab]() / j)), h = i[bb]());
			k >= G.year && (h -= h % j, i[yb](h));
			if (k === G.week) i[wb](i[$a]() - i[vb]() + p(d, 1));
			b = 1;
			if (qb || Za) i = i.getTime(), i = new qa(i +
				Ya(i));
			h = i[bb]();
			for (var d = i.getTime(), m = i[ab](), l = i[$a](), n = !g || !!Za, r = (G.day + (g ? Ya(i) : i.getTimezoneOffset() * 6E4)) % G.day; d < c;) e.push(d), k === G.year ? d = kb(h + b * j, 0) : k === G.month ? d = kb(h, m + b * j) : n && (k === G.day || k === G.week) ? d = kb(h, m, l + b * j * (k === G.day ? 1 : 7)) : d += k * j, b++;
			e.push(d);
			o(Ha(e, function(a) {
	...
	ka.prototype.getLogTickPositions = function(a, b, c, d) {
		...
		if (!d) this._minorAutoInterval =
			null;
		if (a >= 0.5) a = B(a), g = this.getLinearTickPositions(a, b, c);
		else if (a >= 0.08)
			for (var f = S(b), h, i, k, j, m, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !m; f++) {
				i = e.length;
				for (h = 0; h < i && !m; h++) k = Da(na(f) * e[h]), k > b && (!d || j <= c) && j !== A && g.push(j), j > c && (m = !0), j = k
			} else if (b = na(b), c = na(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = p(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = sb(a, null, rb(a)), g = Ba(this.getLinearTickPositions(a,
					b, c), Da), !d) this._minorAutoInterval = a / 5;
		if (!d) this.tickInterval = a;
		return g
	};
	var Pb = z.Tooltip = function() {
		this.init.apply(this, arguments)
	};
	Pb.prototype = {
		init: function(a, b) {
		...
		getPosition: function(a, b, c) {
			var d = this.chart,
				...
				r = function() {
					m.apply(0, i) !== !1 ? l.apply(0, k) === !1 && !h && (n(!0), r()) : h ? f.x = f.y = 0 : (n(!0), r())
				};
	...
	var ha;
	db = y && y.documentElement.ontouchstart !== A;
	...
	Xa.prototype = {
		init: function(a, b) {
			...
			this.pinchDown =
				[];
			this.lastValidTouch = {};
			if (z.Tooltip && b.tooltip.enabled) a.tooltip = new Pb(a, b.tooltip), this.followTouchMove = p(b.tooltip.followTouchMove, !0);
			this.setDOMEvents()
		},
		...
		runPointActions: function(a) {
			...
			g && (e ? g.noSharedTooltip : g.directTouch) && f ? m = [f] : (o(c, function(b) {
				...
				k = !e &&
					b.directTouch;
				b.visible && !i && !k && p(b.options.enableMouseTracking, !0) && (l = b.searchPoint(a, !i && b.kdDimensions === 1)) && j.push(l)
			}), o(j, function(a) {
				a && o(["dist", "distX"], function(b, c) {
					typeof a[b] === "number" && a[b] < h[c] && (h[c] = a[b], m[c] = a)
				})
			}));
			if (e)
				for (b = j.length; b--;)(j[b].clientX !== m[1].clientX || j[b].series.noSharedTooltip) && j.splice(b, 1);
			if (m[0] && (m[0] !== this.prevKDPoint || d && d.isHidden))
				if (e && !m[0].series.noSharedTooltip) j.length && d && d.refresh(j, a), o(j, function(b) {
					b.onMouseOver(a, b !== (g && g.directTouch &&
						f || m[0]))
			...
			if (!this._onDocumentMouseMove) this._onDocumentMouseMove = function(a) {
				if (T[ha]) T[ha].pointer.onDocumentMouseMove(a)
			}, M(y, "mousemove", this._onDocumentMouseMove);
			o(e ? j : [p(m[1], f)], function(b) {
				var c = b && b.series;
				c && o(["xAxis", "yAxis", "colorAxis"], function(d) {
					c[d] &&
						c[d].drawCrosshair(a, b)
				})
			})
		},
		reset: function(a, b) {
			...
			if (a) g.refresh(h), e && (e.setState(e.state, !0), o(c.axes, function(a) {
				...
				if (d) d.onMouseOut();
				g && g.hide(b);
				if (this._onDocumentMouseMove) V(y, "mousemove",
		...
		drag: function(a) {
			...
			if (!l || !l.touch)
				if (d < h ? d = h : d > h + k && (d = h + k), e < i ? e = i : e > i + j && (e = i + j), this.hasDragged = Math.sqrt(Math.pow(n - d, 2) + Math.pow(r - e, 2)), this.hasDragged > 10) {
					m = b.isInsidePlot(n - h, r - i);
					if (b.hasCartesianSeries &&
						(this.zoomX || this.zoomY) && m && !s && !l) this.selectionMarker = l = b.renderer.rect(h, i, f ? 1 : k, g ? 1 : j, 0).attr({
		...
		onContainerMouseMove: function(a) {
			var b = this.chart;
			if (!q(ha) || !T[ha].mouseIsDown) ha = b.index;
			a = this.normalize(a);
			a.returnValue = !1;
	...
	u(z.Pointer.prototype, {
		...
		pinchTranslateDirection: function(a,
			...
			B ? (t -= 0.8 * (t - g[k][0]), w || (z -= 0.8 * (z - g[k][1])), c()) : g[k] = [t, z];
			o || (f[k] = s - n, f[l] = r);
			f = o ? 1 / p : p;
			e[l] = r;
			e[k] = b;
	...
	if (E.PointerEvent || E.MSPointerEvent) {
		var va = {},
			...
			Eb = function(a, b, c, d) {
				if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && T[ha]) d(a), d = T[ha].pointer, d[b]({
					type: c,
		...
		u(Xa.prototype, {
			...
			batchMSEvents: function(a) {
				...
				a(this.chart.container, Db ? "pointermove" : "MSPointerMove",
	...
	ob.prototype = {
		init: function(a, b) {
			var c =
				...
				e = b.itemMarginTop || 0;
			this.options = b;
			if (b.enabled) c.itemStyle = d, c.itemHiddenStyle = D(d, b.itemHiddenStyle), c.itemMarginTop = e, c.padding = d = p(b.padding, 8), c.initialItemX = d, c.initialItemY = d - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.symbolWidth = p(b.symbolWidth, 16), c.pages = [], c.render(), M(c.chart, "endResize", function() {
		...
		colorizeItem: function(a, b) {
			...
			if (f) {
				if (g && f.isMarker)
					for (k in i.stroke = h, g = a.convertAttribs(g), g) d = g[k], d !== A && (i[k] = d);
				f.attr(i)
			}
		},
		...
		renderItem: function(a) {
			...
			if (!o) {
				...
				a.legendItem = o = c.text("",
					m ? f + g : -g, this.baseline || 0, w).css(D(a.visible ? h : i)).attr({
					align: m ? "left" : "right",
					zIndex: 2
				}).add(a.legendGroup);
			...
			this.itemHeight = g = B(a.legendItemHeight ||
				c.height);
			if (e && this.itemX - s + f > (l || b.chartWidth - 2 * k - s - d.x)) this.itemX = s, this.itemY += r + this.lastLineHeight + n, this.lastLineHeight = 0;
			...
			this.offsetWidth = l || t((e ? this.itemX - s - j : f) + k, this.offsetWidth)
		},
		getAllItems: function() {
			var a = [];
			o(this.chart.series, function(b) {
				var c = b.options;
				if (p(c.showInLegend, !q(c.linkedTo) ? A : !1, !0)) a = a.concat(b.legendItems || (c.legendType === "point" ? b.data : b))
			});
			return a
		},
		...
		handleOverflow: function(a) {
			...
			if (a > f) {
				...
				b.scroll(0);
				a = f
			} else if (l) v(c.chartHeight), l.hide(), this.scrollGroup.attr({
				translateY: 1
			}), this.clipHeight = 0;
			return a
		},
		scroll: function(a, b) {
			...
			e > d && (e = d);
			if (e >
				0) b !== A && Ua(b, this.chart), this.nav.attr({
				translateX: k,
	...
	hb.prototype = {
		...
		getContainer: function() {
			...
			!isNaN(d) && T[d] && T[d].hasRendered && T[d].destroy();
			K(a, "data-highcharts-chart",
				this.index);
			a.innerHTML = "";
			...
			this.renderer = new(z[c.renderer] || cb)(a, d, e, c.style,
		...
		setSize: function(a, b, c) {
			...
			if (q(a)) d.chartWidth = e = t(0, B(a)), d.hasUserSize = !!e;
			if (q(b)) d.chartHeight = f = t(0, B(b));
			a = g.globalAnimation;
			(a ? Wa : L)(d.container, {
				width: e + "px",
				height: f + "px"
		...
		setChartSize: function(a) {
			...
			this.plotHeight = m = t(0, B(e - k - this.marginBottom));
		...
		drawChartBox: function() {
			...
			if (m) h ? h.animate(x) : this.plotBGImage = b.image(m, r, p, o, v).add();
			w ? w.animate({
				width: t.width,
				height: t.height
			...
			if (l) g ? g.animate(g.crisp({
				...
				height: v,
				strokeWidth: -l
			})) : this.plotBorder = b.rect(r, p, o, v, 0, -l).attr({
		...
		isReadyToRender: function() {
			var a = this;
			return !ca && E == E.top && y.readyState !== "complete" || ga && !E.canvg ? (ga ? Ob.push(function() {
				a.firstRender()
	...
	Ia.prototype = {
		...
		applyOptions: function(a, b) {
			...
			if (this.x === A && c) this.x = b === A ? c.autoIncrement() : b;
			return this
		},
	...
	Q.prototype = {
			...
			if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible) o(a, function(a, b) {
				...
				if (n && h > n) {
					...
					if (ma(j)) {
						...
						for (c = 0; c < h; c++) r[c] = l, s[c] = a[c], l += j;
						e.xIncrement = l
					} else if (Ja(j))
						if (t)
					...
					for (c = 0; c < h; c++)
						if (a[c] !== A && (j = {
								...
								c), l && q(j.name))) m.names[j.x] = j.name;
				xa(s[0]) && X(14, !0);
				e.data = [];
		...
		processData: function(a) {
			...
			for (i = b.length || 1; --i;) d = l ? k(b[i]) - k(b[i - 1]) : b[i] - b[i - 1], d > 0 && (g === A || d < g) ? g = d : d < 0 && this.requireSorting && X(15);
			this.cropped = f;
			this.cropStart = e;
		...
		generatePoints: function() {
			...
			for (l = 0; l < g; l++) i =
				h + l, k ? m[l] = (new f).init(this, [d[l]].concat(ta(e[l]))) : (b[i] ? j = b[i] : a[i] !== A && (b[i] = j = (new f).init(this, a[i], d[l])), m[l] = j), m[l].index = i;
			if (b && (g !== (c = b.length) || k))
				for (l = 0; l < c; l++)
					if (l === h && !k && (l += g), b[l]) b[l].destroyElements(), b[l].plotX = A;
			this.data = b;
			this.points = m
		},
		getExtremes: function(a) {
			...
			for (m = 0; m < d; m++)
				if (k = c[m], j = a[m], i = j !== null && j !==
					A && (!b.isLog || j.length || j > 0), k = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[m + 1] || k) >= g && (c[m - 1] || k) <= h, i && k)
					if (i = j.length)
		...
		translate: function() {
			...
			this.generatePoints();
			for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, k = i === "between" || ma(i), j = a.threshold,
					m = a.startFromThreshold ? j : 0, l, n, r, o, R = Number.MAX_VALUE, a = 0; a < g; a++) {
				var v = f[a],
					x = v.x,
					w = v.y;
				n = v.low;
				...
				v.plotX = l = F(t(-1E5, c.translate(x, 0, 0, 0, 1, i, this.type === "flags")), 1E5);
				if (b && this.visible && !v.isNull && u && u[x]) o = this.getStackIndicator(o, x, this.index), u = u[x], w = u.points[o.key], n = w[0], w = w[1], n === m && (n = p(j, e.min)), e.isLog && n <= 0 && (n = null), v.total = v.stackTotal = u.total, v.percentage = u.total && v.y / u.total *
					100, v.stackY = w, u.setOffset(this.pointXOffset || 0, this.barW || 0);
				v.yBottom = q(n) ? e.translate(n, 0, 1, 0, 1) : null;
				h && (w = this.modifyValue(w, v));
				v.plotY = n = typeof w === "number" && w !== Infinity ? F(t(-1E5, e.translate(w, 0, 1, 0, 1)), 1E5) : A;
				v.isInside = n !== A && n >= 0 && n <= e.len && l >= 0 && l <= c.len;
				v.clientX = k ? c.translate(x, 0, 0, 0, 1) : l;
				v.negative = v.y < (j || 0);
				v.category = d && d[v.x] !== A ? d[v.x] : v.x;
				a && (R = F(R, P(l - r)));
				r = l
			}
		...
		getValidPoints: function() {
			return Ha(this.points, function(a) {
				return !a.isNull
			})
		},
		setClip: function(a) {
			...
			a || (i.count -= 1, i.count <= 0 && h && b[h] && (f || (b[h] = b[h].destroy()), b[h +
		...
		drawPoints: function() {
			var a, b = this.points,
				...
				v =
				p(m.enabled, this.xAxis.isRadial, this.closestPointRangePx > 2 * m.radius);
			if (m.enabled !== !1 || this._hasPointMarkers)
				for (f = b.length; f--;)
					if (g = b[f], d = S(g.plotX), e = g.plotY, j = g.graphic, n = g.marker || {}, r = !!g.marker, a = v && n.enabled === A || n.enabled, o = g.isInside, a && e !== A && !isNaN(e) && g.y !== null)
						if (a = g.pointAttr[g.selected ? "select" : ""] || l, h = a.r, i = p(n.symbol, this.symbol), k = i.indexOf("url") === 0, j) j[o ? "show" : "hide"](!0).attr(a).animate(u({
							x: d - h,
							y: e - h
						}, j.symbolName ? {
							width: 2 * h,
							...
							if (o && (h > 0 || k)) g.graphic =
								c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h, r ? n : m).attr(a).add(t)
		...
		getAttribs: function() {
			...
			var s = a.zones,
				t = a.zoneAxis || "y",
				v;
			b.marker ? (e.radius = e.radius || c.radius + e.radiusPlus, e.lineWidth = e.lineWidth || c.lineWidth + e.lineWidthPlus) : (e.color = e.color || ia(e.color || g).brighten(e.brightness).get(), e.negativeColor = e.negativeColor || ia(e.negativeColor || h).brighten(e.brightness).get());
			...
			if (!j || g < j || k)
				for (; g--;) {
					j = i[g];
					if ((c = j.options && j.options.marker ||
							j.options) && c.enabled === !1) c.radius = 0;
					if (s.length) {
						k = 0;
		...
		getGraphPath: function(a, b, c) {
			...
			o(a, function(i, k) {
				var j = i.plotX,
					m = i.plotY,
					l = a[k - 1];
				if ((i.leftCliff || l && l.rightCliff) && !c) h = !0;
				i.isNull && !q(b) && k > 0 ? h = !e.connectNulls : i.isNull && !b ? h = !0 : (k === 0 || h ? l = ["M", i.plotX,
					i.plotY
				] : d.getPointSpline ? l = d.getPointSpline(a, i, k) : f ? (l = f === "right" ? ["L", l.plotX, m] : f === "center" ? ["L", (l.plotX + j) / 2, l.plotY, "L", (l.plotX + j) / 2, m] : ["L", j, l.plotY], l.push("L", j, m)) : l = ["L", j, m], g.push.apply(g, l), h = !1)
			});
		...
		applyZones: function() {
			var a = this,
				...
				s = m.horiz,
				q, v, x, w = !1;
			if (d.length && (i || k) && m.min !== A) i && i.hide(), k && k.hide(), l = m.getExtremes(), o(d, function(d, o) {
				e = n ? s ? b.plotWidth : 0 : s ? 0 : m.toPixels(l.min);
				e = F(t(p(f, e), 0), j);
				f = F(t(B(m.toPixels(p(d.value, l.max), !0)), 0), j);
				w && (e = f = m.toPixels(l.max));
				q = Math.abs(e - f);
				v = F(e, f);
				x = t(e, f);
				if (m.isXAxis) {
	...
	Q.prototype.setStackedPoints = function() {
		if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
			...
			for (x = 0; x < d; x++) {
				...
				q = (s = j && u < (g ? 0 : f)) ? k : i;
				l[q] || (l[q] = {});
				if (!l[q][w]) n[q] && n[q][w] ? (l[q][w] = n[q][w], l[q][w].total = null) : l[q][w] = new Kb(m, m.options.stackLabels, s, w, h);
				q = l[q][w];
				if (u !== null) q.points[v] = q.points[this.index] = [p(q.cum, g)], q.touched = m.stacksTouched, o.index > 0 && this.singleStacks === !1 && (q.points[v][0] =
					q.points[this.index + "," + w + ",0"][0]);
				e === "percent" ? (s = s ? i : k, j && l[s] && l[s][w] ? (s = l[s][w], q.total = s.total = t(s.total, q.total) + P(u) || 0) : q.total = ea(q.total + (P(u) || 0))) : q.total = ea(q.total + (u || 0));
				q.cum = p(q.cum, g) + (u || 0);
	...
	Q.prototype.setPercentStacks = function() {
		...
		o([b, "-" + b], function(b) {
			...
			for (var g = d.length, h, i; g--;)
				if (h = d[g],
					e = a.getStackIndicator(e, h, a.index), f = (i = c[b] && c[b][h]) && i.points[e.key], h = f) i = i.total ? 100 / i.total : 0, h[0] = ea(h[0] * i), h[1] = ea(h[1] * i), a.stackedYData[g] = h[1]
		})
	};
	...
	u(Ia.prototype, {
		update: function(a, b, c, d) {
			function e() {
				...
				if (Y(a) && !Ja(a)) f.redraw = function() {
					if (h && h.element && a &&
						a.marker && a.marker.symbol) f.graphic = h.destroy();
	...
	u(ka.prototype, {
		update: function(a, b) {
			...
			this.destroy(!0);
			this._addedPlotLB = this.chart._labelPanes =
				A;
			this.init(c, u(a, {
				events: A
			}));
	...
	var la = pa(Q, {
		...
		getStackPoints: function() {
			var a = [],
				...
				i = d.series,
				k = i.length,
				j, m = p(d.options.reversedStacks, !0) ? 1 : -1,
				l, n;
			if (this.options.stacking) {
				for (l = 0; l < g.length; l++) f[g[l].x] = g[l];
				...
				o(b, function(g, i) {
					...
					if (f[g] && !f[g].isNull) a.push(f[g]), o([-1, 1], function(a) {
						var c =
							a === 1 ? "rightNull" : "leftNull",
							d = 0,
							n = e[b[i + a]];
						if (n)
							for (l = h; l >= 0 && l < k;) p = n.points[l], p || (l === h ? f[g][c] = !0 : j[l] && (q = e[g].points[l]) && (d -= q[1] - q[0])), l += m;
		...
		getGraphPath: function(a) {
			var b = Q.prototype.getGraphPath,
				...
				s = function(b, c, f) {
					var g = a[b],
						...
						f = g[f + "Cliff"] || 0,
						o, r, g = !0;
					f || p ? (o = (p ? b[0] : b[1]) + f, r = b[0] + f, g = !!p) : !d && a[c] && a[c].isNull && (o = r = l);
					o !== void 0 && (i.push({
						plotX: j,
			...
			for (f = 0; f < a.length; f++)
				if (g = a[f].isNull, j = p(a[f].rectPlotX, a[f].plotX), o = p(a[f].yBottom,
						n), !g || c) {
					c || s(f, f - 1, "left");
	...
	wa = pa(Q, {
		...
		getPointSpline: function(a, b, c) {
			...
			if (f && !f.isNull && c && !c.isNull) {
				...
				k += j;
				h >
					a && h > e ? (h = t(a, e), k = 2 * e - h) : h < a && h < e && (h = F(a, e), k = 2 * e - h);
	...
	wa = pa(Q, {
		...
		getColumnMetrics: function() {
			...
			b.grouping === !1 ? h = 1 : o(a.chart.series, function(b) {
				var c = b.options,
					e = b.yAxis,
					i;
				if (b.type === a.type && b.visible && d.len === e.len && d.pos === e.pos) c.stacking ? (f = b.stackKey, g[f] === A && (g[f] = h++), i = g[f]) :
		...
		drawPoints: function() {
			...
			o(a.points, function(h) {
				var i = h.plotY,
					k = h.graphic;
				if (i !== A && !isNaN(i) && h.y !== null) f = h.shapeArgs, i = q(a.borderWidth) ? {
		...
		animate: function(a) {
			var b = this.yAxis,
				...
				e = {};
			if (ca) a ? (e.scaleY = 0.001, a = F(b.pos + b.len, t(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len : e.translateY = a, this.group.attr(e)) : (e.scaleY = 1, e[d ? "translateX" : "translateY"] = b.pos, this.group.animate(e, this.options.animation), this.animate = null)
		},
		remove: function() {
			var a = this,
				b = a.chart;
	...
	da = {
		...
		translate: function(a) {
			...
			this.getX = function(b, c) {
				h = W.asin(F((b - a[1]) / (a[2] / 2 + m), 1));
				return a[0] + (c ? -1 : 1) * U(h) * (a[2] / 2 + m)
			};
			for (l = 0; l < n; l++) {
				o = j[l];
				f = k + b * i;
				...
				o.angle = h;
				e = F(e, m / 2);
				o.labelPos = [a[0] + f + U(h) * m, a[1] + g + $(h) * m, a[0] + f + U(h) * e, a[1] + g + $(h) * e, a[0] + f, a[1] + g, m < 0 ? "center" : o.half ? "right" : "left", h]
			}
		},
		drawGraph: null,
		drawPoints: function() {
	...
	Q.prototype.drawDataLabels = function() {
		...
		if (d.enabled || a._hasPointLabels) a.dlProcessOptions && a.dlProcessOptions(d), k = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), p(d.defer, !0) && (k.attr({
			opacity: +h
	...
	Q.prototype.alignDataLabel = function(a, b, c, d, e) {
		...
		if (n) d = u({
			...
			width: k.width,
			height: k.height
		}), m ? (o = !1, g = f.renderer.rotCorr(j, m), g = {
				x: d.x + c.x + d.width / 2 + g.x,
				y: d.y + c.y + d.height / 2
			}, b[e ? "attr" : "animate"](g).attr({
				align: c.align
			}),
			h = (m + 720) % 360, h = h > 180 && h < 360, l === "left" ? g.y -= h ? k.height : 0 : l === "center" ? (g.x -= k.width / 2, g.y -= k.height / 2) : l === "right" && (g.x -= k.width, g.y -= h ? 0 : k.height)) : (b.align(c, null, d), g = b.alignAttr), o ? this.justifyDataLabel(b, c, g, k, d, e) : p(c.crop, !0) && (n = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + k.width, g.y + k.height)), c.shape && !m && b.attr({
			anchorX: a.plotX,
			anchorY: a.plotY
		});
		if (!n) Oa(b), b.attr({
			...
			if (a.visible && (e.enabled || a._hasPointLabels)) {
				...
				for (D = 2; D--;) {
					...
					if (K) {
						...
						for (C = b = 0; !b && I[C];) b = I[C] && I[C].dataLabel && (I[C].dataLabel.getBBox().height || 21),
							C++;
						if (l > 0) {
							x = F(q + r + l, d.plotHeight);
							for (C = t(0, q - r - l); C <= x; C += b) H.push(C);
							x = H.length;
							if (K > x) {
								c = [].concat(I);
								c.sort(L);
						...
						for (C = 0; C < K; C++) {
							...
							A = e.justify ? n[0] + (D ? -1 : 1) * (r + l) : a.getX(y === q - r - l || y === q + r + l ? c : y, D);
							v._attr = {
								visibility: E,
								align: w[6]
							};
							...
							v.connX = A;
							v.connY = y;
							if (this.options.size === null) x = v.width, A - x < f ? G[3] = t(B(x - A + f), G[3]) : A + x > h - f && (G[1] = t(B(A + x - h + f), G[1])), y - b / 2 < 0 ? G[0] = t(B(-y + b / 2), G[0]) : y + b / 2 > i && (G[2] = t(B(y + b / 2 - i), G[2]))
						}
					}
				}
				if (Ea(G) === 0 || this.verifyDataLabelOverflow(G)) this.placeDataLabels(),
					u && g && o(this.points, function(b) {
						k = b.connector;
						w = b.labelPos;
						if ((v = b.dataLabel) && v._pos && b.visible) E = v._attr.visibility, A = v.connX, y = v.connY, j = m ? ["M", A + (w[6] === "left" ? 5 : -5), y, "C", A, y, 2 * w[2] - w[4], 2 * w[3] - w[5], w[2], w[3], "L", w[4], w[5]] : ["M", A + (w[6] === "left" ? 5 : -5), y, "L", w[2], w[3], "L", w[4], w[5]], k ? (k.animate({
							d: j
		...
		b.prototype.hideOverlappingLabels = function(a) {
			...
			for (e = 0; e < b; e++) {
				k =
					a[e];
				for (d = e + 1; d < b; ++d)
					if (j = a[d], k && j && k.placed && j.placed && k.newOpacity !== 0 && j.newOpacity !== 0 && (m = k.alignAttr, l = j.alignAttr, n = k.parentGroup, o = j.parentGroup, p = 2 * (k.box ? 0 : k.padding), m = !(l.x + o.translateX > m.x + n.translateX + (k.width - p) || l.x + o.translateX + (j.width - p) < m.x + n.translateX || l.y + o.translateY > m.y + n.translateY + (k.height - p) || l.y + o.translateY + (j.height - p) < m.y + n.translateY)))(k.labelrank < j.labelrank ? k : j).newOpacity = 0
			}
			c(a, function(a) {
				var b, c;
				if (a) {
	...
	da = z.TrackerMixin = {
		...
		drawTrackerGraph: function() {
			...
			if (e && !c)
				for (j = e + 1; j--;) d[j] ===
					"M" && d.splice(j + 1, 0, d[j + 1] - i, d[j + 2], "L"), (j && d[j] === "M" || j === e) && d.splice(j, 0, "L", d[j - 2] + i, d[j - 1]);
			k ? k.attr({
				d: d
		...
		pan: function(a, b) {
			...
			o(b === "xy" ? [1, 0] : [1], function(b) {
				var b = c[b ? "xAxis" : "yAxis"][0],
					...
					i = i > h;
				if (b.series.length && (i || m > F(j.dataMin, j.min)) && (!i || k < t(j.dataMax, j.max))) b.setExtremes(m, k, !1, !1, {
					trigger: "pan"
				}), e = !0;
				c[d] = h
			});
			...
			if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (k || h && i.enabled === !1) || a && m.states && m.states[a] && m.states[a].enabled === !1)) {
				if (this.graphic) g = g && this.graphic.symbolName && o.r, this.graphic.attr(D(o, g ? {
					...
					if (a && i)
						...
						else if (m) e.stateMarkerGraphic = j = l.renderer.symbol(m, c - g, d - g, 2 * g, 2 * g).attr(o).add(e.markerGroup),
						j.currentSymbol = m;
